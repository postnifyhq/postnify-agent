# Postnify CLI - Project Structure

## Overview

The Postnify CLI is a complete command-line interface package for interacting with the Postnify social media scheduling API. It's designed for developers and AI agents to automate social media posting.
...
│   ├── api.ts                    # API client for Postnify API
...
#### `src/api.ts`
- API client class `PostnifyAPI`
- Handles all HTTP requests to the Postnify API
- Methods for:
  - Creating posts
  - Listing posts
  - Deleting posts
...
- `uploadFile()` - Upload images to Postnify
...
- Version: `1.0.0`
- Executable bin: `postnify` → `dist/index.js`
...
|----------|----------|---------|-------|
| `POSTNIFY_API_KEY` | ✅ Yes | - | Authentication token |
...
POSTNIFY_API_KEY=test node dist/index.js integrations:list
```
...
2. **Features**
   - Interactive mode
   - Config file support (~/.postnifyrc)
...
- **Issues:** https://github.com/postnifyhq/postnify-app/issues
- **Docs:** See README.md, SKILL.md, QUICK_START.md
- **Website:** https://postnify.com
