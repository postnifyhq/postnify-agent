...
All notable changes to the Postnify CLI will be documented in this file.
...
### Added
- Initial release of Postnify CLI
...
- Environment variable configuration (POSTNIFY_API_KEY, POSTNIFY_API_URL)
